...
// updating from http.createClient, in _getSOAPResponse(), using request instead
...
Gateway.prototype.OLD_getSOAPResponse = function(soap, func, callback) {
  var self = this;
...
Gateway.prototype._getSOAPResponse = function(soap, func, callback) {
  ...
  _HOST.port = this.port;
  _HOST.pathname = this.path;
  var _URL = url.format(_HOST);
